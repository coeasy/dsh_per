...
export interface EngineCtx {
  ...
  // per-session / per-task mutable bookkeeping (owned by the core)
  ...
  oneShot: Map<string, { forced?: boolean; passthrough?: boolean }>;
  ...
  // messaging + classification helpers
  ...
  // lifecycle callbacks implemented in the core (transition stays there)
